declare module "react-native-pure-navigation-bar" {
    ...
    type ButtonType = string | React.ReactElement<any>;
    type ButtonsType = ButtonType | ButtonType[];
    type ButtonFuncType = (index: number) => boolean | undefined;
